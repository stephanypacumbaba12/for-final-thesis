...
class Animals1_vid : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.animals}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Animals_AgeFour::class.java).apply {
