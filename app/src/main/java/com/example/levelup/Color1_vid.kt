...
class Color1_vid : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.color}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Color_AgeFour::class.java).apply {
