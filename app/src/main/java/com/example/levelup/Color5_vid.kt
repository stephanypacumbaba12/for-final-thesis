...
class Color5_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.color1}")
        ...
        doneButton.setOnClickListener {
            println("Navigating to Color_AgeFive with Username: $username, Subject: $subject")

            val intent = Intent(this, Color_AgeFive::class.java).apply {
