...
class Color6_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.color2}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Color_AgeSix::class.java).apply {
