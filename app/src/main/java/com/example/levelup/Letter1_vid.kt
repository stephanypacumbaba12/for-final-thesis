...
class Letter1_vid : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.letter}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Letter_AgeFour::class.java).apply {
