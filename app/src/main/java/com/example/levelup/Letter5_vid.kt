...
class Letter5_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.letter1}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Letter_AgeFive::class.java).apply {
