...
class Letter6_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.letter2}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Letter_AgeSix::class.java).apply {
