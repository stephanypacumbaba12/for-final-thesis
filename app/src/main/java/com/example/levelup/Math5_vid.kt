...
class Math5_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.mathematics1}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Math_AgeFive::class.java).apply {
