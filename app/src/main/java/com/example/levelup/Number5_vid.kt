...
class Number5_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.number1}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Number_AgeFive::class.java).apply {
