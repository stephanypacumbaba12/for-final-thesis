...
class Planet6_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.planet2}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Planet_AgeSix::class.java).apply {
