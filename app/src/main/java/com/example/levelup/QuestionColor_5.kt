...
class QuestionColor_5 : AppCompatActivity() {

    private var lastFeedbackIndex = -1
    private lateinit var levelData: QuestionAnswer_color5.LevelData
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        levelData = QuestionAnswer_color5.getLevelData(currentLevel)
            ?: run {
