...
class QuestionColor_6 : AppCompatActivity() {

    private var lastFeedbackIndex = -1
    private lateinit var levelData: QuestionAnswer_color6.LevelData
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        subject = intent.getStringExtra("subject") ?: "Color"
        ...
        levelData = QuestionAnswer_color6.getLevelData(currentLevel)
            ?: run {
