...
class QuestionLetter_4 : AppCompatActivity() {

    private var lastFeedbackIndex = -1
    private lateinit var levelData: QuestionAnswer_letter4.LevelData
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        levelData = QuestionAnswer_letter4.getLevelData(currentLevel)
            ?: run {
