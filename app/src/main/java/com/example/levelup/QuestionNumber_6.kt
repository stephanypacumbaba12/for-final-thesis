...
class QuestionNumber_6 : AppCompatActivity() {

    private var lastFeedbackIndex = -1
    private lateinit var levelData: QuestionAnswer_number6.LevelData
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        levelData = QuestionAnswer_number6.getLevelData(currentLevel)
            ?: run {
