...
class QuestionShape_4 : AppCompatActivity() {

    private var lastFeedbackIndex = -1
    private lateinit var levelData: QuestionAnswer_shape4.LevelData
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        levelData = QuestionAnswer_shape4.getLevelData(currentLevel)
            ?: run {
