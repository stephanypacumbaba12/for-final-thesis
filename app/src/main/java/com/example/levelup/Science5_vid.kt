...
class Science5_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.science1}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Science_AgeFive::class.java).apply {
