...
class Shape5_vid : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.shape1}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Shape_AgeFive::class.java).apply {
