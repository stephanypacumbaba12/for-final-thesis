...
class Vegetables1_vid : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set the video URI
        val videoUri = Uri.parse("android.resource://${packageName}/${R.raw.vegetables}")
        ...
        doneButton.setOnClickListener {
            val intent = Intent(this, Vegetable_AgeFour::class.java).apply {
